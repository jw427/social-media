...
public class PostService {
    ...
    // 외부 SNS API 호출 부분 (기능 개발을 위한 요소로, 실제 동작하지 않음)
    public void snsLikeApi(String snsType, String postId) {
        String endpoint = "";
...
//        String response = restTemplate.postForObject(endpoint, null, String.class);
    ...
    // 외부 SNS API 호출 부분 (기능 개발을 위한 요소로, 실제 동작하지 않음)
    public void snsShareApi(String snsType, String postId) {
        String endpoint = "";
